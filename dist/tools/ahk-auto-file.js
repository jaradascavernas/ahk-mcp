...
import { loadConfig, saveConfig, setActiveFile, getActiveFile, detectFilePaths, resolveFilePath } from '../core/config.js';
...
export class AhkAutoFileTool {
    ...
    async execute(args) {
        try {
            ...
            response += `• Active File: ${cfg.activeFile || 'None'}\n`;
