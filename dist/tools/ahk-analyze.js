...
export class AhkAnalyzeTool {
    ...
    async findBuiltInFunctions(code, lines, ahkIndex, analysis, options) {
    ...
    async findBuiltInVariables(code, lines, ahkIndex, analysis, options) {
    ...
    async findClassUsage(code, lines, ahkIndex, analysis, options) {
    ...
    analyzeUserDefinedElements(parseResult, analysis) {
        ...
        // Hotkeys
        parseResult.hotkeys.forEach((hotkey) => {
        ...
        // Directives
        parseResult.directives.forEach((directive) => {
