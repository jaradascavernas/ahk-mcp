...
import { AhkEditTool } from './ahk-edit.js';
import { AhkFileTool } from './ahk-file.js';
...
export class AhkFileEditorTool {
    ...
    async execute(args) {
        try {
            ...
            response += `• \`ahk_edit\` - For direct text replacements, insertions, deletions\n`;
