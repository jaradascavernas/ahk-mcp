// Simple test for path conversion system
import { PathConverter, PathFormat } from './dist/utils/path-converter.js';
import { PathInterceptor } from './dist/core/path-interceptor.js';
import { configManager } from './dist/core/path-converter-config.js';
